...
public class SecurityConfig {
    ...
    public UserDetailsService userDetailsService() {
        return new CustomUserDetailsService(repository); // Ensure UserInfoService implements UserDetailsService
    }
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/auth/user/**").hasAuthority("ROLE_USER") // Kiểm tra quyền ROLE_USER
                        .requestMatchers("/auth/admin/**").hasAuthority("ROLE_ADMIN") // Kiểm tra quyền ROLE_ADMIN
                        .anyRequest().authenticated() // Bảo vệ tất cả các endpoint còn lại
                )
